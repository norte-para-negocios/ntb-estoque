...
//  a quantidade real — 2,5 aparece como "2,5", nao "2"/"3".)
...
// Override de TAMANHO escolhido pelo usuario (largura/altura em cm). O resto do
// padrao vem do etiqueta_config da loja.
