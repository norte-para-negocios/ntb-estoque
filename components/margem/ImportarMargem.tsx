...
export function ImportarMargem({ label = 'Importar do Omie' }: { label?: string }) {
  ...
  function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    start(async () => {
      const r = await fetch('/relatorio-margem/importar', { method: 'POST', body: fd })
      ...
      toast.success(`Margem importada: ${j.linhas} linhas (${j.ano})`)
      router.refresh()
    })
  }
