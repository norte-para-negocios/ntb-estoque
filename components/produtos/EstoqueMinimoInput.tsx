...
export function EstoqueMinimoInput({
  ...
  return (
    <input
      ...
      onBlur={salvar}
      placeholder="—"
      className="num w-16 rounded-md border border-border bg-surface px-2 py-1 text-right text-sm text-text outline-none focus:border-brand disabled:opacity-60"
    />
  )
}
