    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-item" onclick="window.location.href='/notas'">
                    <i class="fas fa-file-invoice"></i>
                    <span>Notas Fiscais</span>
                </div>
                <div class="menu-item" onclick="window.location.href='/ordens'">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Ordens de Produção</span>
                </div>
                <div class="menu-item" onclick="window.location.href='/inventario'">
                    <i class="fas fa-cubes"></i>
                    <span>Inventário</span>
                </div>
                <div class="menu-item" onclick="window.location.href='/transferencias'">
                ...
                <div class="auth-section">
                    <div class="auth-buttons">
                        ...
                        <div class="menu-item auth-item logout" onclick="window.location.href='/logout'">
