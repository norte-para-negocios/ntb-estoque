                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ $action == 'create' ? route('loja.store') : route('loja.update', $loja->id) }}"
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pj_nome" name="nome" required value="{{ $loja->nome }}">
                                </div>
                            </div>

                            <div class="mb-4 row align-items-center">
                                <label for="pj_fantasia" class="form-label col-sm-3 col-form-label">Nome fantasia</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pj_fantasia" name="fantasia" required value="{{ $loja->nome_fantasia }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control cep" id="pj_cep" name="cep" value="{{ $loja->cep }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pj_logradouro" name="logradouro" value="{{ $loja->logradouro }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pj_numero" name="numero" value="{{ $loja->numero }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pj_bairro" name="bairro" value="{{ $loja->bairro }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pj_cidade" name="cidade" value="{{ $loja->cidade }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="pj_uf" name="uf">
                                        @foreach (\App\Helpers\Constants::UF as $key => $value)
                                            <option value="{{ $key }}" @if($key == $loja->uf) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="omie_app_key" name="omie_app_key" value="{{ $loja->omie_app_key }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                <label for="omie_app_secret" class="form-label col-sm-3 col-form-label">OMIE -
                                    SECRET</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="omie_app_secret" name="omie_app_secret" value="{{ $loja->omie_app_secret }}">
                                </div>
                            </div>
