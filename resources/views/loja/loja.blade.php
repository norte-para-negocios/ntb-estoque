                ...
                <div class="card">
                    <form action="{{ $action == 'create' ? route('loja.store') : route('loja.update', $loja->id) }}"
                        ...
                        <div class="card-header">
                            @if ($action == 'create')
                                <h2 class="mb-4">{{ __('Nova Loja') }}</h2>
                            @else
                                <h2 class="mb-4">{{ __('Editando Loja: ') . $loja->nome }}</h2>
                            @endif
                            <p>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="switchCheckDefault" name="ativo"
